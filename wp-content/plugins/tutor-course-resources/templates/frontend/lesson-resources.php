<?php
/**
 * Template: Recursos de lección en frontend
 *
...
<div class="tutor-lesson-resources-section">
	<div class="tutor-lesson-resources-header">
		<h3>
			<span class="dashicons dashicons-media-document"></span>
			<?php esc_html_e( 'Recursos de la Lección', 'tutor-course-resources' ); ?>
		</h3>
	</div>
	
	<div class="tutor-lesson-resources-list">
