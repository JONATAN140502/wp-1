...
class Media extends WP_REST_Controller {
      ...
      array(
		...
		register_rest_route(
			...
			array(
				'args'   => array(
					'media_type' => array(
						'description' => __( 'media type name to get specific media.', 'droip' ),
						'type'        => 'string',
					),
				),
				array(
		...
		register_rest_route(
			...
			array(
				'args'   => array(
					'post_id' => array(
						'description' => __( 'Unique post id for the object.', 'droip' ),
						'type'        => 'integer',
					),
				),
				array(
	...
	public function post_items_permissions_check( $request ) {
		return HelperFunctions::has_access(array(DROIP_ACCESS_LEVELS['FULL_ACCESS']));
	}
	...
	public function update_media_item($request)
	{
		...
		if ($media_id === -1) {
			return new WP_Error(
				...
				__('Media item can not be updated.', 'droip'),
				array('status' => 400)
			);
		}
	...
	public function trash_or_restore_item( $request ) {
		...
		if ( $post_id === -1 ) {
			return new WP_Error(
				...
				__( 'Media can not move to trash or restore.', 'droip' ),
				array( 'status' => 400 )
			);
		}
	...
	public function prepare_item_for_response($item, $request)
	{
		...
		$categories = DROIP_SUPPORTED_MEDIA_TYPES;
	...
	public function get_item_schema() {
		...
		$schema = array(
			...
			'properties' => array(
				'id'       => array(
					'description' => __( 'Unique identifier for the object.', 'droip' ),
					'type'        => 'integer',
					'context'     => array( 'view', 'edit' ),
					'readonly'    => true,
				),
				'name'     => array(
					'description' => __( 'Name of the media item.', 'droip' ),
					'type'        => 'string',
					'context'     => array( 'view', 'edit' ),
					'arg_options' => array(
				...
				'alt'      => array(
					'description' => __( 'Alt of the media item.', 'droip' ),
					'type'        => 'string',
					'context'     => array( 'view', 'edit' ),
					'arg_options' => array(
						'sanitize_callback' => 'sanitize_text_field',
				...
				'type'     => array(
					'description' => __( 'Media mime type.', 'droip' ),
					'type'        => 'string',
					'context'     => array( 'view', 'edit' ),
					'arg_options' => array(
						'sanitize_callback' => 'sanitize_text_field',
				...
				'category' => array(
					'description' => __( 'Media category.', 'droip' ),
					'type'        => 'string',
					'context'     => array( 'view', 'edit' ),
					'arg_options' => array(
						'sanitize_callback' => 'sanitize_text_field',
				...
				'url'      => array(
					'description' => __( 'Media url.', 'droip' ),
					'type'        => 'string',
					'context'     => array( 'view', 'edit' ),
					'arg_options' => array(
						'sanitize_callback' => 'sanitize_text_field',
				...
				'trash'    => array(
					'description' => __( 'Media trash or not.', 'droip' ),
					'type'        => 'string',
					'context'     => array( 'view', 'edit' ),
					'arg_options' => array(
						'sanitize_callback' => 'sanitize_text_field',
				...
				'total'    => array(
					'description' => __( 'Total media items.', 'droip' ),
					'type'        => 'integer',
					'context'     => array( 'view', 'edit' ),
					'readonly'    => true,
				),
				'date'     => array(
					'description' => __( "The date the object was published, in the site's timestamp.", 'droip' ),
					'type'        => 'string',
					'format'      => 'date-time',
					'context'     => array( 'view' ),
					'readonly'    => true,
